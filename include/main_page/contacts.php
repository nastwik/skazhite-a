                  ...
                  <div class="container">
                     ...
                     <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative">
                                <img src="images/icons/white/calendar.webp" class="abs bg-color-3 w-100px p-15 rounded-1 mb-3 wow scaleIn" alt="">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative">
                                <img src="images/icons/white/location.png" class="abs bg-color-3 w-100px p-15 rounded-1 mb-3 wow scaleIn" alt="">
                                <div class="relative ps-100 ms-4 wow fadeInUp">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="relative">
                                <img src="images/icons/white/phone.png" class="abs bg-color-3 w-100px p-15 rounded-1 mb-3 wow scaleIn" alt="">
