            <section>
                <div class="container relative">
                    ...
                    <div class="col-lg-6">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/doctors/olga_black-mini.webp" class="w-100 rounded-1" alt="">
                    </div>
                    <div class="col-lg-6 relative">
                        ...
                        <div class="team_butns">
                            <a class="btn-main btn-red wow fadeInUp" data-wow-delay=".4s" href="<?php echo get_permalink(147); ?>">Подробнее</a>
