            ...
            <div class="row g-4">
               <div class="col-lg-4 col-md-6">
                  <div class="relative bg-white p-4 rounded-1 formula-content">
                     ...
                     <div>
                        <div class="item-title mb-0">индивидуальный подход к каждому</div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="relative bg-white p-4 rounded-1 formula-content">
                     ...
                     <div>
                        <div class="item-title mb-0">профессиональное оборудование</div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="relative bg-white p-4 rounded-1 formula-content">
                     ...
                     <div>
                        <div class="item-title mb-0">квалифицированная помощь</div>
                     </div>
                  </div>
               </div>
