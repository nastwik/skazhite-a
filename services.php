            ...
            <div class="row g-4 gx-5 align-items-center">
               <div class="col-lg-6 relative">
                     <div class="relative z-1000">
                        ...
                        <h2>По формуле из трех элементов</h2>
               ...
               <div class="col-lg-6">
                  <div class="p-5 bg-color text-light rounded-1 h-100">
                     <h3 class="mb-3">«Тревожные звоночки», чтобы обратиться к ЛОРу:</h3>
                     <ul class="ol-style-1">
            ...
            <div class="row g-4">
               <div class="col-lg-4 col-md-6">
                  <div class="relative bg-white p-4 rounded-1 formula-content">
                     ...
                     <div>
                        <h4 class="mb-0">индивидуальный подход к каждому</h4>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="relative bg-white p-4 rounded-1 formula-content">
                     ...
                     <div>
                        <h4 class="mb-0">профессиональное оборудование</h4>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="relative bg-white p-4 rounded-1 formula-content">
                     ...
                     <div>
                        <h4 class="mb-0">квалифицированная помощь</h4>
                     </div>
                  </div>
               </div>
