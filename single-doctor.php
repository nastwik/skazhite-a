            ...
            <div class="row g-3 align-items-center">
               <div class="col-lg-6">
                  <div class="relative z-1000">
                     <h1 class="wow fadeInUp mb-2" data-wow-delay=".2s">Князева Ольга Александровна</h1>
                     <p class="lead col-lg-10 mb-0 wow fadeInUp" data-wow-delay=".4s">Ваш лор-эксперт</p>
                     <div class="spacer-single"></div>
                  </div>
               </div>
               <div class="col-lg-6">
                  <div class="template-offer__img">
                     <img src="images/misc/8.png" class="w-100" data-wow-delay=".6s" alt="" data-0="transform: translateY(0px);" data-500="transform: translateY(300px);">
                  </div>
               </div>    
            </div>
         </div>
            ...
            <div class="row g-4 gx-5 align-items-center">
               ...
               <div class="col-lg-6 relative">
                  <div class="relative z-1000">
                     ...
                     <h2>За это клиенты доверяют мне свои уши, горло и нос</h2>
